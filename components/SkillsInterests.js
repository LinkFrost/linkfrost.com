export default function SkillsInterests() {
  return (
    <div className="flex flex-col justify-between content-center max-w-3xl mb-5 w-full border-b-0 border-red-200 border-opacity-100">
      {/* <h2 className="font-bold text-xl sm:text-3xl text-white mb-5">Proficient Languages & Skills</h2>

      <div className="grid grid-cols-3 sm:grid-rows-2 sm:grid-cols-5 md:grid-rows-none md:grid-cols-9 md:gap-10 gap-12 justify-between m-auto mb-10">
      ...
      <h2 className="font-bold text-xl sm:text-3xl text-white mb-5">Areas of Interest 💡</h2>
      ...
      <div className="inline-grid grid-cols-3 sm:grid-cols-3 gap-4 sm:gap-5 text-gray-400 mb-5">
        ...
        <p className="flex justify-center align-center">AI/ML</p>
        <p className="flex justify-center align-center">Microservices</p>
      </div>
    </div>
  );
}
