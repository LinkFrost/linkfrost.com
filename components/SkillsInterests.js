export default function SkillsInterests() {
  return (
    <div className="flex flex-col justify-between content-center max-w-3xl mb-5 w-full border-b-2 border-red-200 border-opacity-100">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-9 gap-10 justify-between m-auto mb-5">
        ...
        <img style={{ height: "50px", width: "auto" }} src="/img/ReactLogo.png" alt="React"></img>
        <img style={{ height: "50px", width: "auto" }} src="/img/PythonLogo.png" alt="Python"></img>
        <img style={{ height: "50px", width: "auto" }} src="/img/CLogo.png" alt="C"></img>
        <img style={{ height: "50px", width: "auto" }} src="/img/JavaLogo.png" alt="Java"></img>
        <img style={{ height: "50px", width: "auto" }} src="/img/MongoDBLogo.png" alt="MongoDB"></img>
        <img style={{ height: "50px", width: "auto" }} src="/img/PostgreSQLLogo.png" alt="PostgreSQL"></img>
      </div>
      <div className="flex justify-center">
