...
export default function ProjectCard(props) {
  return (
    <div className="sm:aspect-square relative flex flex-col items-center rounded-xl border-4 border-red-200 bg-neutral-900 shadow-md shadow-black hover:shadow-lg hover:shadow-zinc-700 p-2">
