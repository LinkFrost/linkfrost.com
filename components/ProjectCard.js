export default function ProjectCard(props) {
  return (
    <div className="sm:aspect-square relative flex flex-col items-center rounded-xl border-1 border-red-200 bg-neutral-800 shadow-md shadow-black hover:shadow-xl hover:shadow-zinc-800 p-2">
